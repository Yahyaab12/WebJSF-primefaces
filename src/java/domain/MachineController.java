...
public class MachineController implements Serializable {
    ...
    public MachineController(MachineFacade ejbFacade, Machine selected, Employee selectedEmployee, MachineFacade machineFacade ) {
    ...
    // Implement the logic to filter machines based on the selected employee
        if (selectedEmployee != null) {
            return ejbFacade.findMachinesByEmployee(selectedEmployee);
        } else {
            return ejbFacade.findAll();
        }
    }
    public List<Machine> getMachinesByEmployeeAndYear(Employee selectedEmployee, Year acquisitionYear) {
        return machineFacade.findMachinesByEmployeeAndYear(selectedEmployee, acquisitionYear);
    }
